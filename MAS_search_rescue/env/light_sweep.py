...
class Sweep:
    ...
    def __init__(self, map_ori, map_shape, agent_light, agent_heavy, h_a):
        ...
        self.h_a_init = h_a
        self.h_a = h_a
        self.start_list = [np.array([self.map_row_s + self.agent_l.r_sens,     self.map_col_s + self.agent_l.r_sens]),
                           np.array([self.map_row_s + self.agent_l.r_sens,     self.map_col_e - self.agent_l.r_sens - 1]),
                           np.array([self.map_row_e - self.agent_l.r_sens - 1, self.map_col_s + self.agent_l.r_sens]),
                           np.array([self.map_row_e - self.agent_l.r_sens - 1, self.map_col_e - self.agent_l.r_sens - 1])]
    ...
    def sweep_path_random(self):
        ...
        len_central = self.map_col_e - self.map_col_s - 2 * self.agent_l.r_sens
